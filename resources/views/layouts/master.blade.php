    ...
    <body>
        ...
        <div id="wrapper">
            ...
            <header class="header_area bg-img background-overlay-white"
                    style="background-image: url({{ asset('front/img/bg-img/bg-1.jpg') }});">
                                            ...
                                            <ul class="cart-list">
                                                <li>
                                                    <a href="#" class="image"><img
                                                            src="{{ asset('front/img/product-img/product-10.jpg') }}"
                                                ...
                                                <li>
                                                    <a href="#" class="image"><img
                                                            src="{{ asset('front/img/product-img/product-11.jpg') }}"
                                                            class="cart-thumb" alt=""></a>
                                                    <div class="cart-item-desc">
                                                        <h6><a href="#">Women's Fashion</a></h6>
                                                        <p>1x - <span class="price">$10</span></p>
                        ...
                        <div class="col-12 col-md-6 col-lg-3">
                            <div class="single_footer_area">
                                <div class="footer-logo">
                                    <img src="{{ asset('front/img/core-img/logo.png') }}" alt="">
                                </div>
                                <div class="copywrite_text d-flex align-items-center">
                                    <p>
                                        ...
                                        by <a href="https://colorlib.com" target="_blank">Colorlib</a> &amp; distributed

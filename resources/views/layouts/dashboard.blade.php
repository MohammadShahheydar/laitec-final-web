...
<html lang="en">
    <head>
        ...
        <link href="{{ asset('back/css/datatables-style.css') }}" rel="stylesheet"/>
        <link href="{{ asset("/back/css/styles.css") }}" rel="stylesheet"/>
        @yield('css')
        <script src="{{ asset('back/js/all.js') }}" crossorigin="anonymous"></script>
    </head>
                        ...
                        <div class="nav">
                            ...
                            <div class="collapse" id="collapsePages" aria-labelledby="headingTwo"
                                ...
                                <nav class="sb-sidenav-menu-nested nav accordion" id="sidenavAccordionPages">
                                    ...
                                    <a class="nav-link collapsed" href="{{ url("#") }}" data-bs-toggle="collapse"
                                       data-bs-target="#pagesCollapseIndex" aria-expanded="false"
                                       aria-controls="pagesCollapseIndex">
                                        Index
                                        <div class="sb-sidenav-collapse-arrow"><i class="fas fa-angle-down"></i></div>
                                    </a>
                                    <div class="collapse" id="pagesCollapseIndex" aria-labelledby="headingOne"
                                         data-bs-parent="#sidenavAccordionPages">
                                        <nav class="sb-sidenav-menu-nested nav">

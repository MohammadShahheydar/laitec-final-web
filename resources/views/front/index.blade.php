...
@section('content')
    ...
    <section class="top_catagory_area d-md-flex clearfix">
        <!-- Single Catagory -->
        <div class="single_catagory_area d-flex align-items-center bg-img" style="background-image: url({{ asset('front/img/bg-img/bg-2.jpg') }});">
        ...
        <!-- Single Catagory -->
        <div class="single_catagory_area d-flex align-items-center bg-img" style="background-image: url({{ asset('front/img/bg-img/bg-3.jpg') }});">
            <div class="catagory-content">
                        ...
                        <div class="single-testimonial-area text-center">
                            ...
                            <div class="testimonial-info d-flex align-items-center justify-content-center">
                                <div class="tes-thumbnail">
                                    <img src="{{ asset('front/img/bg-img/tes-1.jpg') }}" alt="">
                                </div>

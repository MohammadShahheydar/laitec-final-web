                ...
                <div class="col-12 col-md-4 col-lg-3">
                    <div class="shop_sidebar_area">
                        ...
                        <div class="widget color mb-70">
                            ...
                            <div class="widget-desc">
                                <ul class="d-flex justify-content-between">
                                    <li class="gray"><a href="{{ url("#") }}"><span>(3)</span></a></li>
                                    <li class="red"><a href="{{ url("#") }}"><span>(25)</span></a></li>
                                    <li class="yellow"><a href="{{ url("#") }}"><span>(112)</span></a></li>
                                    <li class="green"><a href="{{ url("#") }}"><span>(72)</span></a></li>
                                    <li class="teal"><a href="{{ url("#") }}"><span>(9)</span></a></li>
                                    <li class="cyan"><a href="{{ url("#") }}"><span>(29)</span></a></li>
                                </ul>
                            </div>
                        </div>
                        ...
                        <div class="widget size mb-50">
                            ...
                            <div class="widget-desc">
                                <ul class="d-flex justify-content-between">
                                    <li><a href="{{ url("#") }}">XS</a></li>
                                    <li><a href="{{ url("#") }}">S</a></li>
                                    <li><a href="{{ url("#") }}">M</a></li>
                                    <li><a href="{{ url("#") }}">L</a></li>
                                    <li><a href="{{ url("#") }}">XL</a></li>
                                    <li><a href="{{ url("#") }}">XXL</a></li>
                                </ul>
                            </div>
                        </div>
                            ...
                            <div class="widget-desc">
                                ...
                                <div class="single-recommended-product d-flex mb-30">
                                    <div class="single-recommended-thumb mr-3">
                                        <img src="{{ asset("front/img/product-img/product-10.jpg") }}" alt="">
                                    </div>
                                ...
                                <div class="single-recommended-product d-flex mb-30">
                                    <div class="single-recommended-thumb mr-3">
                                        <img src="{{ asset("front/img/product-img/product-11.jpg") }}" alt="">
                                    </div>
                                    <div class="single-recommended-desc">
                                        <h6>Blue mini top</h6>
                                        <p>$ 19.99</p>
                                ...
                                <div class="single-recommended-product d-flex">
                                    <div class="single-recommended-thumb mr-3">
                                        <img src="{{ asset("front/img/product-img/product-12.jpg") }}" alt="">
                                    </div>
                                    <div class="single-recommended-desc">

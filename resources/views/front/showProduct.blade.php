            ...
            <div class="row">
                    ...
                    <div class="single_product_thumb">
                        <div id="product_details_slider" class="carousel slide" data-ride="carousel">
                            ...
                            <ol class="carousel-indicators">
                                @php
                                    $productSliders = $product->productSliders
                                @endphp

                                @forelse($productSliders as $key => $productSlider )
                                    <li class="active" data-target="#product_details_slider" data-slide-to="{{ $key }}"
                                        style="background-image: url({{ asset('images/productSlider/'.$productSlider->image) }});">
                                    </li>
                                @empty
                                @endforelse
                                {{--                                <li data-target="#product_details_slider" data-slide-to="1"--}}
                                {{--                                    style="background-image: url({{ asset('front/img/product-img/product-2.jpg') }});">--}}
                                {{--                                </li>--}}
                                {{--                                <li data-target="#product_details_slider" data-slide-to="2"--}}
                                {{--                                    style="background-image: url({{ asset('front/img/product-img/product-3.jpg') }});">--}}
                                {{--                                </li>--}}
                                {{--                                <li data-target="#product_details_slider" data-slide-to="3"--}}
                                {{--                                    style="background-image: url({{ asset('front/img/product-img/product-4.jpg') }});">--}}
                                {{--                                </li>--}}
                            </ol>
                            ...
                            <div class="carousel-inner">
                                <div class="carousel-item active">
                                    <a class="gallery_img"
                                       href="{{ asset('images/productSlider/'.$productSlider->image) }}">
                                ...
                                @forelse($productSliders as $key => $productSlider)
                                    <div class="carousel-item">
                                        <a class="gallery_img" href="{{ asset('images/productSlider/'.$productSlider->image) }}">
                                            <img class="d-block w-100"
                                                 src="{{ asset('images/productSlider/'.$productSlider->image) }}"
                                                 alt="Second slide">
                                        </a>
                                    </div>
                                @empty
                                ...
                                {{--                                        <img class="d-block w-100"--}}
                                {{--                                             src="{{ asset("/front/img/product-img/product-2.jpg") }}"--}}
                                {{--                                             alt="Second slide">--}}
                                {{--                                    </a>--}}
                                {{--                                </div>--}}
                                {{--                                <div class="carousel-item">--}}
                                ...
                                {{--                                        <img class="d-block w-100"--}}
                                {{--                                             src="{{ asset("/front/img/product-img/product-3.jpg") }}"--}}
                                {{--                                             alt="Third slide">--}}
                                {{--                                    </a>--}}
                                {{--                                </div>--}}
                                {{--                                <div class="carousel-item">--}}
                                ...
                                {{--                                        <img class="d-block w-100"--}}
                                {{--                                             src="{{ asset("/front/img/product-img/product-4.jpg") }}"--}}
                                {{--                                             alt="Fourth slide">--}}
                                {{--                                    </a>--}}
                                {{--                                </div>--}}
                            </div>
                ...
                <div class="col-12 col-md-6">
                    <div class="single_product_desc">
                        ...
                        <h4 class="title"><a href="{{ url("#") }}">{{ ucfirst($product->title) }}</a></h4>
                        ...
                        <div id="accordion" role="tablist">
                            <div class="card">
                                <div class="card-header" role="tab" id="headingOne">
                                    <h6 class="mb-0">
                                        <a data-toggle="collapse" href="{{ url("#collapseOne") }}" aria-expanded="true"
                            ...
                            <div class="card">
                                <div class="card-header" role="tab" id="headingTwo">
                                    <h6 class="mb-0">
                                        <a class="collapsed" data-toggle="collapse" href="{{ url("#collapseTwo") }}"
                                ...
                                <div id="collapseTwo" class="collapse" role="tabpanel" aria-labelledby="headingTwo"
                                    ...
                                    <div class="card-body">
                                        <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Explicabo quis in
                                            veritatis officia inventore, tempore provident dignissimos nemo, nulla
                                            quaerat. Quibusdam non, eos, voluptatem reprehenderit hic nam! Laboriosam,
                            ...
                            <div class="card">
                                <div class="card-header" role="tab" id="headingThree">
                                    <h6 class="mb-0">
                                        <a class="collapsed" data-toggle="collapse" href="{{ url("#collapseThree") }}"

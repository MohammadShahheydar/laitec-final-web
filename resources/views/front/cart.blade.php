                ...
                <div class="col-12">
                            ...
                            <tbody>
                                <tr>
                                    <td class="cart_product_img d-flex align-items-center">
                                        <a href="{{ url("#") }}"><img src="{{ asset("/front/img/product-img/product-9.jpg") }}" alt="Product"></a>
                    ...
                    <div class="cart-footer d-flex mt-30">
                        <div class="back-to-shop w-50">
                            <a href="{{ url("shop-grid-left-sidebar.html") }}">Continue shooping</a>
                        </div>
                        <div class="update-checkout w-50 text-right">
                            <a href="{{ url("#") }}">clear cart</a>
                            <a href="{{ url("#") }}">Update cart</a>
                        </div>
                    </div>
            ...
            <div class="row">
                ...
                <div class="col-12 col-lg-4">
                    <div class="cart-total-area mt-70">
                        ...
                        <a href="{{ url("checkout.html") }}" class="btn karl-checkout-btn">Proceed to checkout</a>
                    </div>
                </div>
            </div>
        </div>
